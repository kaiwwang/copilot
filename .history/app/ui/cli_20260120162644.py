...
class CliApp:
        ...
        while reasoning_steps < self.MAX_REASONING_STEPS:
            ...
            if agent_output.intent == "tool_request" and agent_output.tool:
                ...
                if tool_result and tool_result.get("success"):
                    ...
                    context = self._format_tool_result(tool_name, tool_result.get("result"))
                ...
                # Continue reasoning loop with tool result as context
                continue
    ...
    def _format_tool_result(self, tool_name: str, result: dict) -> str:
        """Format tool result for inclusion in next reasoning context."""
        import json
